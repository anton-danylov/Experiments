...
{
    public interface ISplitChunksStrategy
    {
        string[] SplitFileToSortedChunks(string sortedFilePath, long bytesOfMemoryToConsume, Func<string, int, string> getChunkPath);
    }
}
